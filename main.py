...
mainFrame = Frame(window, width=412, height=272.5, bg="black")
mainFrame.pack()
...
kuadrat = PhotoImage(file = r"images\kuadrat.png")
kuadratimage = kuadrat.subsample(4,4)
kuadrat = Button(mainFrame, text="..2", fg="black", image=kuadratimage, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("**2")).grid(row=0, column=2, padx=1, pady=1)
...
test = PhotoImage(file = r"images\seven.png")
testimage = test.subsample(4,4)
test = Button(mainFrame, text="7", fg="black", image=testimage, bd=0, bg="black", cursor="hand2",
...
zero0 = PhotoImage(file = r"images\02.png")
zero0image = zero0.subsample(4,4)
zero0 = Button(mainFrame, text="00", fg="black",image=zero0image, bd=0, bg="black", cursor="hand2",
              command=lambda: clickButton("00")).grid(row=4, column=2, padx=1, pady=1)
...
point = Button(mainFrame, text=".", fg="black",image=pointimage, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton(".")).grid(row=4, column=0, padx=1, pady=1)
